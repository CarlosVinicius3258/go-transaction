...
import "github.com/carlosvinicius3258/go-transaction/entity"
...
func (p *ProcessTransaction) Execute(input TransactionDtoInput) (TransactionDtoOutput, error){
	...
	return approveTransaction(p, transaction)
}

func approveTransaction(p *ProcessTransaction, transaction *entity.Transaction) (TransactionDtoOutput, error) {
